...
```bash
pnpm tauri:build        # 生产包：Whalito_0.3.0_x64-setup.exe（DSH 端口 3080，数据目录 ~/.dsh）
pnpm tauri:build:test   # 测试包：Whalito-Test_0.3.0_x64-setup.exe（DSH 端口 30080，数据目录 ~/.dsh-test）
```
