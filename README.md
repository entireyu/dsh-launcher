...
1. 在 [Releases](https://github.com/entireyu/dsh-whalito-desk/releases) 下载最新安装包 `Whalito_0.4.6_x64-setup.exe`
...
1. 在 [Releases](https://github.com/entireyu/dsh-whalito-desk/releases) 下载最新 `Whalito_0.4.6_universal.dmg`
...
```bash
pnpm tauri:build        # 生产包：Whalito_0.4.6_x64-setup.exe（DSH 端口 3080，数据目录 ~/.dsh）
